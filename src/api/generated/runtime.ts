...
export class BaseAPI {
    ...
    private fetchApi = async (url: string, init: RequestInit) => {
        ...
        try {
            ...
            response = await this.handleFetchError(e, response, fetchParams);
        }
        for (const middleware of this.middleware) {
            if (middleware.post) {
    ...
    private handleFetchError = async (error: unknown, response: Response | undefined, fetchParams: { url: string, init: RequestInit }): Promise<Response> => {
      for (const middleware of this.middleware) {
