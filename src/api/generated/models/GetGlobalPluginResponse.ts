...
export function GetGlobalPluginResponseFromJSON(
  json: any,
...
export function GetGlobalPluginResponseToJSON(
  json: any,
): GetGlobalPluginResponse {
  return GetGlobalPluginResponseToJSONTyped(json, false);
}

export function GetGlobalPluginResponseToJSONTyped(
  value?: GetGlobalPluginResponse | null,
