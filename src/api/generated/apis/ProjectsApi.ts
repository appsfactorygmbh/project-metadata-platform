...
export interface ProjectsApiInterface {
   ...
   */
  projectsFilterDataBusinessunitsGetRaw(
   ...
   */
  projectsFilterDataBusinessunitsGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   * @memberof ProjectsApiInterface
   */
  projectsFilterDataTeamnumbersGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
   ...
   */
  projectsFilterDataTeamnumbersGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  projectsPutRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<CreateProjectResponse>>;
  ...
  implements ProjectsApiInterface
{
   ...
   * Retrieves a distinct list of all business units from the projects.
   */
  async projectsFilterDataBusinessunitsGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<string>>> {
   ...
   * Retrieves a distinct list of all team numbers from the projects.
   */
  async projectsFilterDataTeamnumbersGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<number>>> {
    const queryParameters: any = {};
  ...
  async projectsPutRaw(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      CreateProjectResponseFromJSON(jsonValue),
    );
  }
  ...
  async projectsPut(
    requestParameters: ProjectsPutRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<CreateProjectResponse | null | undefined> {
