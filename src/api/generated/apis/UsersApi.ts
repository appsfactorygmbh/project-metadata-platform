...
export interface UsersApiInterface {
  ...
  ): Promise<runtime.ApiResponse<Array<GetAllUsersResponse>>>;
  ...
  usersGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<GetAllUsersResponse>>;
...
export class UsersApi extends runtime.BaseAPI implements UsersApiInterface {
  ...
  async usersGetRaw(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(GetAllUsersResponseFromJSON),
    );
  }
  ...
  async usersPut(
    requestParameters: UsersPutRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<CreateUserResponse | null | undefined> {
