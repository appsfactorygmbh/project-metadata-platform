...
<template>
  <a-form ref="formRef" :model="dynamicValidateForm">
    <a-form-item :name="props.attributeName" class="formItem">
      <a-select v-model:value="dynamicValidateForm[props.attributeName]" mode="tags" :placeholder="props.placeholder"
        :token-separators="[',']" @paste="handlePaste" @search="onSearch">
      </a-select>
    </a-form-item>
  </a-form>
</template>
